...
final class AnnotationMappers {
    ...
    static void decorateOperationFromAnnotation(Operation annotation, io.swagger.v3.oas.models.Operation operation) {
        ...
        operation.operationId(annotation.method() + "_" + annotation.operationId());
    ...
    private static void mapParameters(Field field, Map<String, Object> map) {
        ...
        if (fields.length == 0 && componentType!= null && !isPrimitiveOrWrapper(componentType)) { //TODO check componentType is Object or other than array type
        ...
        } else if (componentType != null) { //TODO check componentType is Object or other than array type
